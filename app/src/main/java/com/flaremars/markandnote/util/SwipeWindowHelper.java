...
import com.flaremars.markandnote.widget.ShadowView;
...
public class SwipeWindowHelper extends Handler {
    ...
    public void setCanSlideBack(boolean canSlideBack) {
        ...
        switch (msg.what) {
            ...
            case MSG_SLIDE_FINISHED:
                ...
                if (mViewManager != null) {
                    mViewManager.previousViewBmp.recycle();
                    mViewManager.previousViewBmp = null;
                }
    ...
    private class ViewManager {
        ...
        private Bitmap previousViewBmp;
        private View mShadowView;

        private boolean isAllReady() {
            return mPreviousContentView != null && mShadowView != null && mPreviousActivity != null;
        }
        ...
        private boolean addViewFromPreviousActivity() {
            ...
            mPreviousActivity = ComponentHolder.getAppComponent().getActivityLifecycleHelper().getPreActivity();
            ...
            View previousContentView = previousActivityContainer.getChildAt(0);
            previousViewBmp = Bitmap.createBitmap(previousContentView.getWidth(), previousContentView.getHeight(), Bitmap.Config.ARGB_4444);
            Canvas canvas = new Canvas(previousViewBmp);
            previousContentView.draw(canvas);
            mPreviousContentView = new ImageView(getContext());
            ((ImageView) mPreviousContentView).setImageBitmap(previousViewBmp);
